  ...
  return (
    ...
    >
      <article className="relative z-10 mx-auto flex w-full max-w-4xl flex-col gap-7 sm:gap-8">
        ...
        <nav aria-label="Primary actions" className="animate-fade-up flex w-full flex-col gap-3 [animation-delay:260ms] sm:w-auto sm:flex-row sm:flex-wrap sm:items-center sm:gap-4">
          <a
